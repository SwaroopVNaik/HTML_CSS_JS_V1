...
let White_Color = cars.filter( (car) => {
...
for(let car of cars){
    if(car.color === "White"){
        White_Color_V2.push(car)
    }
}
console.log(White_Color_V2);

let new_prices_car = cars.map( (car) =>{
    car.price = car.price + 50000;
    return car;
})

console.log(new_prices_car);

let new_prices_car_V2 = []

for(let car of cars){
    if(car.price = car.price + 50000){
        new_prices_car_V2.push(car)
    }
}

console.log(new_prices_car_V2);
