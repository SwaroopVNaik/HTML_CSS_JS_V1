...
// let UsersZ = user_data.users
// console.log(UsersZ.length);

// let UsersZ_1 = UsersZ.find(user => user.firstName)
// console.log(UsersZ_1);

// method 1 => not optimized
let get_data = async(name) => {
    let user_response = await fetch('https://dummyjson.com/users')
...
get_data("swaroop").then((user) => {console.log(user)});
...
const getData = async (name) => {
  try {
    ...
    return users.find(u => u.firstName.toLowerCase() === name.toLowerCase()) || null;
...
// usage
getData("swaroop").then(console.log);
